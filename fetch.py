#!/usr/bin/env python3
"""
Recupero codici sconto Aosom da shopilo.it
Sursa: https://shopilo.it/negozi/aosom.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/aosom.it"
STORE_NAME = "Aosom"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Aosom da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-aosom)"
    }
    try:
